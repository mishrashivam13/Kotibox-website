    ...
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full sm:max-w-[740px] rounded-t-3xl sm:rounded-2xl shadow-[0_32px_80px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row max-h-[92vh] sm:max-h-[95vh]">
        ...
        <div className="hidden md:flex relative bg-[#07101f] md:w-[42%] flex-shrink-0 flex-col justify-between p-8 overflow-hidden">
          ...
          <div
            className="absolute -top-24 -right-24 w-64 h-64 rounded-full opacity-[0.08]"
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-2.5 mb-8">
              <div className="w-8 h-8 bg-[#f5a623] rounded-lg flex items-center justify-center font-bold text-[#07101f] text-xs">
                KB
              </div>
          ...
          <div className="relative z-10 grid grid-cols-3 gap-2 pt-6 border-t border-white/[0.08]">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <div className="text-xl font-bold text-[#f5a623] leading-none">{s.num}</div>
        ...
        <div className="flex-1 bg-white flex flex-col overflow-y-auto">
          ...
          {/* Form header */}
          <div className="flex items-start justify-between px-5 sm:px-8 pt-4 sm:pt-8 pb-4 sm:pb-6 border-b border-gray-100">
            <div>
              {/* Brand chip — only on mobile since left panel is hidden */}
              <div className="flex items-center gap-2 mb-2 md:hidden">
                <div className="w-6 h-6 bg-[#f5a623] rounded-md flex items-center justify-center text-[#07101f] text-[10px] font-bold">
                  KB
                </div>
                <span className="text-xs font-semibold text-[#0a1628] tracking-wide">
                  Kotibox &middot; Google Certified
                </span>
              </div>
              <h4 className="text-lg sm:text-xl font-bold text-[#0a1628]">Start Your Project</h4>
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-700 transition-all flex-shrink-0 ml-3 mt-0.5"
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="px-5 sm:px-8 py-4 sm:py-6 flex flex-col gap-3 sm:gap-4 flex-1">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-[#f5a623] hover:bg-[#e8950f] text-[#07101f] font-bold py-3.5 rounded-xl transition-all duration-200 shadow-[0_4px_20px_rgba(245,166,35,0.35)] hover:shadow-[0_6px_28px_rgba(245,166,35,0.5)] group"
              >
                Send My Request
              ...
              {/* Trust line */}
              <div className="flex items-center justify-center gap-3 sm:gap-5 pt-1 flex-wrap">
            ...
            /* Success state */
            <div className="flex-1 flex flex-col items-center justify-center px-5 sm:px-8 py-10 sm:py-12 text-center">
              ...
              <h4 className="text-2xl font-bold text-[#0a1628] mb-2">Request Sent!</h4>
