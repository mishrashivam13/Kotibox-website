...
const products: Product[] = [
  // ── OTT Platform ────────────────────────────────────────────────────────────
  {
    ...
    deployment: {
      ...
      support: '3 months post-launch support included. Annual maintenance plans available',
  ...
  // ── AI Chatbot ──────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      { step: '01', title: 'Knowledge Base Ingestion', desc: 'Share your FAQs, product docs, policies, and website URLs. We ingest and embed everything into a vector database.', detail: 'Takes 2–3 days. The more documentation provided, the more accurate the bot is from day one.' },
      ...
      { step: '03', title: 'Integration & Deployment', desc: 'We deploy the web widget on your site (one JS snippet), connect WhatsApp Business API and Instagram, and integrate your CRM for lead sync.', detail: 'Takes 2–4 days. Requires access to your website CMS, WhatsApp Business Manager, and CRM.' },
    ...
    faqs: [
      ...
      { question: 'Can it work on WhatsApp and Instagram as well?', answer: 'Yes. The same knowledge base and conversation logic is deployed across your website widget, WhatsApp Business number, and Instagram DM. Each channel has a UI appropriate to the platform — quick reply buttons on WhatsApp, rich messages on Instagram. You monitor everything from one dashboard.' },
  ...
  // ── Voice AI ─────────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      { step: '01', title: 'Conversation Script Design', desc: 'We map every call scenario your business handles — greetings, FAQs, booking flows, objection handling, and escalation — into conversation trees.', detail: 'Takes 3–5 days. Requires your team to walk us through typical call types.' },
      { step: '02', title: 'Voice & Persona Setup', desc: 'Select or record a voice. We tune speaking pace, tone warmth, and filler word patterns to match your brand — making the AI feel like a trained team member.', detail: 'Takes 2–3 days. Voice cloning requires 5–10 minutes of clean audio.' },
      { step: '03', title: 'Integration & Phone Setup', desc: 'Connect to your phone number via Twilio/SIP trunking. Integrate calendar or CRM for live data lookups during calls. Set up call routing rules.', detail: 'Takes 3–5 days. Requires phone number forwarding and API credentials.' },
  ...
  // ── Food Delivery ────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      { step: '01', title: 'Configuration & Branding', desc: 'We set up your branded customer app, restaurant portal, and rider app with your logo, colours, and city configuration.', detail: 'Takes 3–5 days. Requires brand assets, supported zones/areas, and restaurant onboarding list.' },
    ...
    deployment: {
      ...
      customisation: 'Full white-label — your brand across all 3 apps. Zone configuration, currency, language, and pricing rules configurable',
    ...
    faqs: [
      ...
      { question: 'What is the launch timeline for a new city?', answer: 'With the platform ready-built, launching a new city typically takes 2–4 weeks — primarily for restaurant onboarding (menu data), rider recruitment and app setup, zone configuration, and a soft-launch testing period. Subsequent city launches are faster as the template is established.' },
    ],
  },
  ...
  // ── AI Image Generation ──────────────────────────────────────────────────────
  {
    ...
    steps: [
      { step: '01', title: 'Brand Style Configuration', desc: 'Define your visual identity — colour palette, composition rules, tone (bright/moody/minimal), and style references. This trains the style consistency engine.', detail: 'Takes 2–3 days. Provide 20–30 reference images that represent your brand aesthetic.' },
      { step: '02', title: 'LoRA Fine-Tuning (Optional)', desc: 'If you want AI to generate images featuring your actual products, we train a custom LoRA model on photos of your products.', detail: 'Takes 3–5 days. Requires 20–50 clean product photos per product for accurate results.' },
    ...
    faqs: [
      ...
      { question: 'Can you train the AI on our specific products?', answer: 'Yes. LoRA (Low-Rank Adaptation) fine-tuning trains the image generation model to recognise and include your specific physical products in any generated scene. After training on 20–50 product photos, you can generate: "Put [your product] on a kitchen counter with morning light and a coffee cup" and the AI places your actual product accurately.' },
  ...
  // ── Banking Software ─────────────────────────────────────────────────────────
  {
    ...
    featureDetails: [
      ...
      { title: 'Real-Time Transaction Monitoring', icon: Activity, desc: 'Every transaction monitored against AML (Anti-Money Laundering) rules, FATF guidelines, and custom risk rules in under 200ms. Automated STR (Suspicious Transaction Report) generation for compliance officers.' },
      { title: 'Digital Account Management', icon: Database, desc: 'Full current and savings account lifecycle — account opening with video KYC, statement generation, standing instructions, overdraft management, and interest calculation. Configurable account products for different customer segments.' },
      { title: 'Payment Rails & UPI', icon: Zap, desc: 'Integrated with NEFT, RTGS, IMPS, UPI, and SWIFT payment networks. Supports inward and outward remittances, bulk payment processing, and escrow management. PCI-DSS Level 1 compliant payment handling.' },
      ...
      { title: 'Compliance & Reporting', icon: Award, desc: 'Automated regulatory reporting for RBI, SEBI, and IRDAI requirements. CKYC (Central KYC Registry) integration, CIBIL bureau connectivity, and audit trail for every transaction and customer interaction.' },
    ],
    steps: [
      ...
      { step: '03', title: 'Core Banking Integration', desc: 'Integrate with your existing core banking system (Finacle, Temenos, Oracle FLEXCUBE) or operate as standalone. Connect payment network APIs (NPCI for UPI, NEFT/RTGS).', detail: 'Takes 5–10 days. Requires API credentials and data migration plan if migrating from existing system.' },
    ...
    faqs: [
      { question: 'Is this platform compliant with RBI regulations for Indian banking?', answer: 'Yes. The platform is designed specifically for the Indian regulatory environment — RBI KYC/CKYC guidelines, PMLA compliance, FATF AML requirements, NPCI integration (UPI/IMPS/NEFT), and automated regulatory reporting formats. For state co-operative banks, we also support NABARD and respective state co-operative banking regulations.' },
      { question: 'How does the AI fraud detection work?', answer: 'We use an ensemble ML model trained on transaction patterns, device fingerprints, behavioural biometrics, and historical fraud cases. It scores every transaction in under 200ms — far faster than rule-based systems. The model identifies anomalies like unusual amounts, new devices, unusual geographies, velocity spikes, and account takeover patterns. All flags include explainable AI outputs (which features triggered the flag) for compliance officer review.' },
      { question: 'Can it integrate with existing core banking systems like Finacle or Temenos?', answer: 'Yes. We provide integration adapters for Infosys Finacle, Temenos T24, Oracle FLEXCUBE, and Mphasis BankWare. The platform can operate as a complete standalone system or as a digital-first front-end layer over an existing core banking system, with bidirectional data sync for accounts, transactions, and customer records.' },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 pt-28 pb-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            <div className="pb-16">
              ...
              <p className="text-white/50 text-base md:text-lg font-semibold mb-4" style={{ color: product.accentColor + 'cc' }}>
                {product.tagline}
              </p>
            ...
            {/* Right — product image rising from bottom */}
            ...
            <div className="relative px-8 md:px-14 py-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-black text-white mb-3">
                  Get a Live Demo of <span style={{ color: product.accentColor + 'dd' }}>{product.title.split(' ')[0]} {product.title.split(' ')[1]}</span>
                </h2>
