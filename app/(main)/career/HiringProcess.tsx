...
const steps = [
  {
    ...
    duration: '1-3 days',
    tip: 'ðŸ’¡ Pro tip: Tailor your resume to highlight relevant skills for the role',
  },
  {
    num: 2,
    Icon: Phone,
  ...
  },
  {
    ...
    duration: '2-4 hours',
    tip: 'ðŸ’¡ Pro tip: Focus on quality over speed and document your thought process',
  },
  {
    num: 4,
    Icon: Users,
    ...
    duration: '2-3 hours',
    tip: 'ðŸ’¡ Pro tip: Be prepared to discuss both technical challenges and teamwork experiences.',
  },
  {
    num: 5,
    Icon: Handshake,
...
export default function HiringProcess() {
  ...
  return (
    <section className="bg-[#f5f7fa] py-14 md:py-24 px-6 font-sans overflow-hidden">
      <div className="max-w-[1300px] mx-auto">

        {/* Heading */}
        <div className="text-center mb-20">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0a1628] mb-6">
            Our Hiring Process
          </h2>
        ...
        <div className="mt-10 bg-[#2b4d66] rounded-[2rem] py-14 px-8 md:px-16 flex flex-col md:flex-row items-center justify-between text-white shadow-2xl">
          ...
          <div className="text-center mb-10 md:mb-0">
            <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 tracking-tight">97%</div>
          ...
          <div className="text-center mb-10 md:mb-0">
            <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 tracking-tight">14 days</div>
          ...
          <div className="text-center">
            <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 tracking-tight">95%</div>
